...
import (
	...
	"github.com/Hao-yiwen/go-examples/go-zero/auth-rpc/auth"
	"github.com/Hao-yiwen/go-examples/go-zero/role-rpc/role"
	"github.com/Hao-yiwen/go-examples/go-zero/user-api/internal/config"
	"github.com/Hao-yiwen/go-examples/go-zero/user-rpc/user"
)

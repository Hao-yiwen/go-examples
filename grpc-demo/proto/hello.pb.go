...
const file_proto_hello_proto_rawDesc = "" +
	...
	"\aCreeter\x125\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponseB\x11Z\x0fgrpc-demo/protob\x06proto3"
...
var file_proto_hello_proto_depIdxs = []int32{
	0, // 0: hello.Creeter.SayHello:input_type -> hello.HelloRequest
	1, // 1: hello.Creeter.SayHello:output_type -> hello.HelloResponse

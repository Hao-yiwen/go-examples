...
// GetUser 获取单个用户
func (d *DB) GetUser(id int) *models.User {
	d.mu.RLock()
	defer d.mu.RUnlock()
	return d.users[id]
}
...
// CreateUser 创建用户
func (d *DB) CreateUser(req *models.CreateUserRequest) *models.User {
	d.mu.Lock()
	defer d.mu.Unlock()
...
// UpdateUser 更新用户
func (d *DB) UpdateUser(id int, req *models.UpdateUserRequest) *models.User {
	d.mu.Lock()
	defer d.mu.Unlock()
...
// GetProduct 获取单个产品
func (d *DB) GetProduct(id int) *models.Product {
	d.mu.RLock()
	defer d.mu.RUnlock()
...
func (d *DB) GetAllProducts() []*models.Product {
	d.mu.RLock()
	defer d.mu.RUnlock()
...
// CreateProduct 创建产品
func (d *DB) CreateProduct(req *models.CreateProductRequest) *models.Product {
	d.mu.Lock()
	defer d.mu.Unlock()
...
// UpdateProduct 更新产品
func (d *DB) UpdateProduct(id int, req *models.UpdateProductRequest) *models.Product {
	d.mu.Lock()
	defer d.mu.Unlock()
